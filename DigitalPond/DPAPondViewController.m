...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        UIView * swipeArea = [[UIView alloc] initWithFrame:CGRectMake(20, 20, 280, 40)];
...
-(void)swipe:(UISwipeGestureRecognizer *)gesture
{
    ...
    if (currentBackground == -1) currentBackground = [colors count] - 1;
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self.view insertSubview:bgView atIndex:0]; //addSubview:bgView];
